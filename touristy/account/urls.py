...
urlpatterns = [
    ...
    path('remove_favorite/<int:service_id>/<int:from_favorites>', views.remove_favorite, name='remove_favorite'),
    path('add_rating/', views.add_rating, name='add_rating'),
    path('remove_rating/<int:rating_id>', views.remove_rating, name='remove_rating'),
